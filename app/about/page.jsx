...
const AboutPage = () => {
  ...
  return (
    <FrontLayout>
      ...
      <section className='lg:px-20 px-6 lg:py-20 py-10'>
        <h1 className='lg:text-5xl text-3xl text-blue font-bold'>Our Story & <br />
          History</h1>
        <p className='my-6 text-left text-[#5E5C84]'>
        ...
        <img src="./images/section.png" className='lg:mt-10 h-80 object-cover rounded-xl' alt="" />
      </section>
      ...
      <section className='lg:px-20 px-6 lg:py-20 py-10 lg:mt-20 mt-10 bg-[#F9F9F9]'>
