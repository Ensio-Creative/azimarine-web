    ...
    <FrontLayout>
      ...
      <section className="bg-[#F9F9F9] flex">
        ...
        <div className="p-16 my-auto">
          <h2 className="text-5xl font-bold text-blue">Our
            Company</h2>
      ...
      <section className="mx-20 my-10 border-b border-b-blue">
        <div className="flex justify-between">
          <h1 className="text-5xl font-bold text-blue">Services</h1>
      ...
      <section className="mx-20 my-10">
        <h1 className="text-5xl font-bold text-blue">Statement <br />
          from our MD</h1>
        <div className="flex my-10">
          <img src="./images/md.png" alt="" />
          <div className="bg-[#F9F9F9] rounded-3xl lg:ml-4 p-12">
            <p className="text-blue text-sm">ENGR. MICHAEL ABAKAM</p>
            <p className="text-blue">Managing Director, Azimarine</p>
            <p className="my-8 text-lg text-[#5E5C84]">
